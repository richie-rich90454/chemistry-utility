...
export function calculateDilution(): void{
	try{
		...
		let V2=parseFloat((document.getElementById("dilution-V2") as HTMLInputElement).value);
		let result: number, formula: string;
		let inputs=document.querySelectorAll("#dilution-calc input") as NodeListOf<HTMLInputElement>;
		for (let i=0; i<inputs.length; i++){
		...
		let resultDiv=document.getElementById("dilution-result") as HTMLElement;
...
export function calculateMassPercent(): void{
	try{
		let solute=parseFloat((document.getElementById("mass-solute") as HTMLInputElement).value);
		let solution=parseFloat((document.getElementById("mass-solution") as HTMLInputElement).value);
		let select=document.getElementById("concentration-unit") as HTMLSelectElement;
		let unit=select.value;
		let inputs=document.querySelectorAll("#mass-percent-calc input") as NodeListOf<HTMLInputElement>;
		for (let i=0; i<inputs.length; i++){
			inputs[i].classList.remove("error");
		}
		...
		let resultDiv=document.getElementById("mass-percent-result") as HTMLElement;
...
export function calculateMixing(): void{
	try{
		let C1=parseFloat((document.getElementById("mix-C1") as HTMLInputElement).value);
		let V1=parseFloat((document.getElementById("mix-V1") as HTMLInputElement).value);
		let C2=parseFloat((document.getElementById("mix-C2") as HTMLInputElement).value);
		let V2=parseFloat((document.getElementById("mix-V2") as HTMLInputElement).value);
		let inputs=document.querySelectorAll("#solution-mixing-calc input") as NodeListOf<HTMLInputElement>;
		for (let i=0; i<inputs.length; i++){
			inputs[i].classList.remove("error");
		}
		...
		let resultDiv=document.getElementById("mixing-result") as HTMLElement;
